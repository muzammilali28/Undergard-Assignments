...
:pencil: <b>Instructions for Installing (Windows)</b>
1. Hover over to <b>Top Right</b> of the screen and click on "DOWNLOAD ALL"
2. Extract the files.
...
6. Open the Image "VS2013-Enter-Key.jpg" and follow the instructions there to register the Product Key.<br>
<pre>I would personally suggest to disconnect you internet (Wifi / LAN cabel) first and the register the key to avoid any errors / bugs after successfull registration reconnect your internet</pre>
